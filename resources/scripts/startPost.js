...
(function () {
    ...
    function generatePageNotes() {
        ...
        pageNotesUi += "<div id='pageNotesEmptyState' class='emptyStateContainer'><div class='emptyStateTitle'>此页面没有说明内容。</div><div class='emptyStateContent'>Axure RP中添加的说明将会显示在这里。</div><div class='dottedDivider'></div></div>";
...
(function () {
    ...
    function generateDebug() {
        ...
        pageNotesUi += "<div id='traceEmptyState' class='emptyStateContainer'><div class='emptyStateTitle'>跟踪信息中没有交互。</div><div class='emptyStateContent'>触发的交互将会显示在这里。</div><div class='dottedDivider'></div></div>";
